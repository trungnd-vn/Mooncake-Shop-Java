<%-- 
    Document   : updateCake
    Created on : Oct 12, 2020, 9:52:22 PM
    Author     : HOME
--%>
            ...
            <div class="container">
                <div class="col-lg-12">
                    <div class="hero__search__form">
                        <h3>Update Cake Form</h3> 
                        Status: ${requestScope.NOTI1}
                        <form name="testform" id="testform" enctype="multipart/form-data" action="UpdateCakeController" method="POST">
                            <input type="hidden" name="txtCakeID" value="${requestScope.CakeID}"/>
                            Cake Name: <input type="text" placeholder="Input cake name..." name="txtCakeName" value=""><br/>
                            <font color="red">${requestScope.INVALID.cakeNameError}</font><br/><br/>
                            Description: <input type="text" placeholder="Input Description..." name="txtCakeDescription" value=""><br/><br/>
                            Cake Image: <input type="file" name="txtFile" value=""><br/><br/>
                            Price: <input type="text" placeholder="..." name="txtCakePrice" value=""> VND<br/>
                            <font color="red">${requestScope.INVALID.priceCakeError}</font><br/><br/>
                            Quantity: <input type="text" placeholder="..." name="txtCakeQuantity" value=""><br/>
                            <font color="red">${requestScope.INVALID.quantityCakeError}</font><br/><br/>
                            Created Date: <input type="datetime-local" name="txtCreatedDate" min="2000-01-01T00:00" max="2030-12-31T23:59" value=""><br/>
                            <font color="red">${requestScope.INVALID.createDayError}</font><br/><br/>
                            Exp Date: <input type="datetime-local" name="txtExpDate" min="2000-01-01T00:00" max="2030-12-31T23:59" value=""><br/>
                            <font color="red">${requestScope.INVALID.expDateError}</font><br/><br/>
                            Category: <br/>
                            <select name="cbxCategory" value="">          
                                <c:forEach items="${sessionScope.LISTCATEGORY}" var="list">
                                    <option>${list.categoryID}-${list.categoryName}</option>
                                </c:forEach>
                            </select><br/><br/>
                            Status:<br/><select name="cbxCakeStatus">
                                <option value="Active">Active</option>
                                <option value="Deactive">Deactivate</option>
                            </select><br/>
                            <input type="hidden" name="txtAccAdminUpdate" value="${sessionScope.EMAILID}"><br/>     
                            <input type="submit" value="Update To Shop" name="action"/><br/>
                        </form><br/>              
                    </div>
                </div>
            </div>
